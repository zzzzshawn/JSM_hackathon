...
const CurrentStreak = ({
  ...
  return (
    <div
      className={`${classname} flex items-center justify-center flex-col gap-3 relative rounded-2xl overflow-hidden p-5 -z-10 bg-black/90`}
    >
      {/* <HalfCircleGradient  /> */}
      <Image
      ...
      <p className=" font-modernbold text-lg ">Current Streak</p>
